var AffineTransformation, round_to_precision;

var round_to_precision = function(num, precision) {
  if (precision == null) {
    precision = 10;
  }
...
AffineTransformation = (function() {
  ...
  function AffineTransformation(from, to) {
    ...
    if (this.to.length < (this.dim = this.to[0].length)) {
      throw 'Too few points => under-determined system';
    }
    this.buildHelpMatrices();
    if (!this.gauss_jordan(this.m)) {
      this.addHelpPoint();
      this.buildHelpMatrices();
      if (!this.gauss_jordan(this.m)) {
  ...
  AffineTransformation.prototype.gauss_jordan = function(m, eps) {
    var c, h, maxrow, w, x, y, y2, _i, _j, _k, _l, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
    if (eps == null) {
      eps = 1.0 / Math.pow(10, 10);
    }
    _ref = [m.length, m[0].length], h = _ref[0], w = _ref[1];
  ...
  AffineTransformation.prototype.to_string = function() {
    ...
    res = '';
    for (j = _i = 0, _ref = this.dim; 0 <= _ref ? _i < _ref : _i > _ref; j = 0 <= _ref ? ++_i : --_i) {
      str = "x" + j;
      for (i = _j = 0, _ref1 = this.dim; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
        str += "x" + i + " * " + this.m[i][j + this.dim + 1];
      }
      str += "" + this.m[this.dim][j + this.dim + 1];
      res += str + "\n";
    }
    return res;
  };
  ...
  AffineTransformation.prototype.transformation_matrix = function() {
    ...
    for (j = _i = 0, _ref = this.dim; 0 <= _ref ? _i < _ref : _i > _ref; j = 0 <= _ref ? ++_i : --_i) {
      this.matrix[j] = [];
      for (i = _j = 0, _ref1 = this.dim; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
        this.matrix[j].push(round_to_precision(this.m[i][j + this.dim + 1]));
      }
      this.matrix[j].push(round_to_precision(this.m[this.dim][j + this.dim + 1]));
    }
    return this.matrix;
  };
  ...
  AffineTransformation.prototype.buildHelpMatrices = function() {
    ...
    this.c = (function() {
      ...
      for (i = _i = 0, _ref = this.dim; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        _results.push((function() {
          ...
          _results1 = [];
          for (a = _j = 0, _ref1 = this.dim; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; a = 0 <= _ref1 ? ++_j : --_j) {
            _results1.push(0.0);
          }
          return _results1;
        }).call(this));
    ...
    for (j = _i = 0, _ref = this.dim; 0 <= _ref ? _i < _ref : _i > _ref; j = 0 <= _ref ? ++_i : --_i) {
      for (k = _j = 0, _ref1 = this.dim; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; k = 0 <= _ref1 ? ++_j : --_j) {
        _ref2 = this.from;
    ...
    this.q = (function() {
      ...
      _results = [];
      for (i = _l = 0, _ref3 = this.dim; 0 <= _ref3 ? _l <= _ref3 : _l >= _ref3; i = 0 <= _ref3 ? ++_l : --_l) {
        _results.push((function() {
          var _m, _ref4, _results1;
          _results1 = [];
          for (a = _m = 0, _ref4 = this.dim; 0 <= _ref4 ? _m <= _ref4 : _m >= _ref4; a = 0 <= _ref4 ? ++_m : --_m) {
            _results1.push(0.0);
          }
          return _results1;
        }).call(this));
    ...
    for (_l = 0, _len1 = _ref3.length; _l < _len1; _l++) {
      qi = _ref3[_l];
      qt = qi.concat([1]);
      for (i = _m = 0, _ref4 = this.dim; 0 <= _ref4 ? _m <= _ref4 : _m >= _ref4; i = 0 <= _ref4 ? ++_m : --_m) {
        for (j = _n = 0, _ref5 = this.dim; 0 <= _ref5 ? _n <= _ref5 : _n >= _ref5; j = 0 <= _ref5 ? ++_n : --_n) {
    ...
    return this.m = (function() {
      ...
      _results = [];
      for (i = _o = 0, _ref6 = this.dim; 0 <= _ref6 ? _o <= _ref6 : _o >= _ref6; i = 0 <= _ref6 ? ++_o : --_o) {
